...
const sections = [
  ...
  },
  {
    ...
    items: [
      ...
      "Преміум: $15/місяць (еквівалент у гривнях за курсом НБУ)",
    ],
  },
  {
    icon: Clock,
    title: "Пробний період",
    text: "Платні тарифи включають 14 днів безкоштовного доступу. Після закінчення пробного періоду підписка автоматично переходить на платний режим. Користувач отримує сповіщення за 2 дні до завершення пробного періоду.",
  },
  {
    icon: RefreshCw,
    title: "Зміна тарифу",
